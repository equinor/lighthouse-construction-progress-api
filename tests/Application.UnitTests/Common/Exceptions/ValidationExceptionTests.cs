using lighthouse_construction_progress_api.Application.Common.Exceptions;
using FluentAssertions;
using FluentValidation.Results;
using NUnit.Framework;

namespace lighthouse_construction_progress_api.Application.UnitTests.Common.Exceptions;
